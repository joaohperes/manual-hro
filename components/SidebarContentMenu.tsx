  ...
  return (
    <div className="space-y-2">
      <button
        ...
        className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-100 transition-colors group"
      >
        <div className="flex items-center gap-2">
          <span>{contentList.title}</span>
          <span className="text-xs bg-slate-200 px-1.5 py-0.5 rounded text-slate-600 font-semibold">
      ...
      {isExpanded && (
        <ul className="space-y-1 pl-2 border-l-2 border-slate-300">
