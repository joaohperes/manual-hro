  ...
  return (
    <div className="max-w-4xl mx-auto pb-8">
      ...
      <article className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden print:shadow-none print:border-none">
        {/* Header - Compact */}
        <div className="p-2 md:p-3 border-b border-slate-100 bg-green-50/50 print:bg-white">
          <div className="flex items-center gap-2 mb-1">
            <span className="px-2 py-0.5 rounded-full text-xs font-bold uppercase tracking-wide print:border print:border-green-300 bg-green-100 text-green-700">
              Instrução Normativa
            </span>
        ...
        {/* Footer Disclaimer - Discreet and Collapsible */}
        <div className="border-t border-yellow-100 bg-yellow-50/30">
          <DiscreetDisclaimer
            title="Aviso Legal"
            content="Este documento é uma instrução normativa do HRO. Todas as orientações devem ser seguidas conforme definido pela administração."
          />
        </div>
      </article>
