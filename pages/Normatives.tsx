...
const Normatives: React.FC = () => {
  ...
  const handleSelectItem = (id: string) => {
    const element = document.getElementById(`normativa-${id}`);
    if (element) {
    ...
    <div className="space-y-8 pb-12">
      ...
      {normatives.length > 0 && (
        <TableOfContents
          ...
          title="Lista de Instruções Normativas"
        />
      )}
            ...
            {normatives.map(doc => (
              ...
              >
                <Link
                  ...
                  className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl hover:border-l-4 hover:border-green-600 transition-all border-l-4 border-transparent block h-full"
                >
