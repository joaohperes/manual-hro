  ...
  return (
    <div className="max-w-4xl mx-auto pb-8">
      ...
      <article className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden print:shadow-none print:border-none">
        {/* Header - Compact */}
        <div className="p-2 md:p-3 border-b border-slate-100 bg-slate-50/50 print:bg-white">
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  {/* Collapsible detailed content section - Expanded by default */}
                  {restOfContent && (
                    <CollapsibleContent
        ...
        <div className="border-t border-yellow-100 bg-yellow-50/30">
          <DiscreetDisclaimer
            title="Aviso Legal"
            content="Este documento é um guia de referência rápida para uso interno. A decisão clínica final deve ser sempre individualizada pelo profissional responsável."
          />
        </div>
      </article>
